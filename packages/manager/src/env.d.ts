...
interface ImportMetaEnv {
  ...
  REACT_APP_CHAT_BOOTSTRAP_JS_URL?: string;
  REACT_APP_CHAT_DEPLOYMENT_NAME?: string;
  REACT_APP_CHAT_DEPLOYMENT_URL?: string;
  REACT_APP_CHAT_ORG_ID?: string;
  REACT_APP_CHAT_SCRT2_URL?: string;
